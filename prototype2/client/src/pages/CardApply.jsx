...
export default function CardApply() {
  ...
  const cardGrad = `linear-gradient(135deg, ${savedDesign?.colorFrom || savedDesign?.color_from || card.colorFrom}, ${savedDesign?.colorTo || savedDesign?.color_to || card.colorTo})`
          ...
          <div className="apply-hero-visual">
            {card.imageUrl ? (
              ...
              <div className="apply-big-card" style={{ background: cardGrad }}>
                ...
                {savedDesign && <span className="abc-design-badge">✨ {savedDesign.themeName || savedDesign.theme_name}</span>}
              </div>
            )}
          </div>
        </div>
              ...
              {card.imageUrl ? (
                ...
                <div className="sidebar-card" style={{ background: cardGrad }}>
                  ...
                  <div className="scard-bottom">
                    ...
                    {savedDesign && <span className="scard-design">✨ {savedDesign.themeName || savedDesign.theme_name}</span>}
                  </div>
                </div>
              )}
