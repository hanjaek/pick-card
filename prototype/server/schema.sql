...
('BNK Young 체크카드',      '체크카드',  0,     'VISA',   '2024-01-15', '#FF6B6B', '#FF8E53', '국내전용', 'Y', 'MZ세대를 위한 라이프스타일 체크카드. 편의점, 카페, 대중교통 등 일상에서 가장 자주 쓰는 곳에서 실속 있는 혜택을 제공합니다.'),
('BNK 마이플러스 신용카드', '신용카드', 15000, 'VISA',   '2024-02-01', '#4158D0', '#C850C0', '국내전용', 'N', '생활 전반의 지출을 한 장으로 커버하는 올인원 신용카드. 마트, 주유, 병원, 온라인쇼핑까지 두루 쓸 수 있는 혜택을 제공합니다.'),
('BNK 부산사랑 신용카드',   '신용카드', 10000, 'VISA',   '2024-03-01', '#D71919', '#FF6B35', '국내전용', 'N', '부산 시민을 위한 지역 특화 신용카드. 부산 지역 가맹점 추가 할인과 시내버스·지하철 무료 이용 혜택을 제공합니다.'),
('BNK 하이라이프 신용카드', '신용카드', 50000, 'VISA',   '2024-04-01', '#0F2027', '#2C5364', '해외겸용', 'N', '상위 1%를 위한 프리미엄 신용카드. 공항 라운지 무제한, 해외 수수료 면제, 특급 호텔 우대 등 격이 다른 혜택을 경험하세요.'),
('BNK 그린라이프 체크카드', '체크카드',  0,     'MASTER', '2024-05-01', '#00B09B', '#96C93D', '국내전용', 'Y', '지구를 생각하는 친환경 체크카드. 대중교통과 전기차 충전, 친환경 가맹점에서 알찬 적립 혜택을 제공합니다.'),
('BNK 쇼핑플러스 신용카드', '신용카드', 12000, 'VISA',   '2024-06-01', '#8E2DE2', '#4A00E0', '국내전용', 'N', '온라인 쇼핑 특화 신용카드. 쿠팡, 네이버페이, 무신사, 올리브영 등 주요 쇼핑 채널에서 최고의 적립·할인 혜택을 드립니다.'),
('BNK 트래블 신용카드',     '신용카드', 30000, 'VISA',   '2024-07-01', '#0052D4', '#4364F7', '해외겸용', 'N', '해외여행 특화 카드. 해외 결제 수수료 면제, 공항 라운지, 면세점 할인 등 여행 전 과정에서 프리미엄 서비스를 누리세요.'),
('BNK 알뜰 체크카드',       '체크카드',  0,     'MASTER', '2024-08-01', '#F7971E', '#FFD200', '국내전용', 'Y', '꼼꼼한 절약을 도와주는 실속 체크카드. 전 가맹점 캐시백, 이동통신 요금 할인, ATM 수수료 무료 등 생활비를 아껴드립니다.');
